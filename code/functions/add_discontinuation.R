#' add_discontinuation
#' @description Adds a column which indicates whether a patient 
#' is on or off their assigned treatment (either treatment or placebo)
#' @param data data frame; output from simulate_ontrt_data is used
#' @param beta_discont data frame; parameters of logistic model for discontinuation
add_discontinuation <- function(data, beta_discont){
  ...
  # 3. Calculate the logit of the discontinuation probability
