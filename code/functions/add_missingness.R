...
#' @param data data frame; output from add_discontinuation is used
...
add_missingness <- function(data, theta) {
  ...
  # 3. Calculate missingness probability missingness prob is zero when patient is on-trt
  # 4. Simulate missingess indicator missingness is not intermittent
